(function () {
	...
	mr = (function (mr, $, window, document){
	    ...
	    mr.typed.documentReady = function($){
	        $('.typed-text').each(function(){
	            var text = $(this);
	            text.attr("data-typed-strings") ? text.attr("data-typed-strings").split(",") : [];
	                var themeDefaults = {
	                    strings: [],
	                    typeSpeed: 100,
	                    loop: true,
	            ...
	            new Typed(this, jquery.extend({}, themeDefaults, mr.typed.options, ao));
	...
	// Commented out but still used!
	// @codekit-append "cloud.js";
